...
import DingTalkMobileDingTalkMobile from "dingtalk-jsapi";
import DingTalkStaffService from "../../services/dingtalk/DingTalkStaffService";

const Item = List.Item;

class SubSelector extends PureComponent{
  ...
  render(){
    ...
    return(
      <div className={styles.assigneeSelector}>
        ...
        <div className={styles.assigneeName}>子任务</div>

        <div className={styles.assigneeRightLeft}></div>
        {/*{*/}
